...
case $1 in
	...
	"ocd")
		...
		;;
	"clrnotf")
		pkill dunst && sleep 0.6 && eww update reveal_no_notification_text=true
		;;
	"clntfpop")
		eww update noti=false && sleep 0.275; eww close notification-popup; eww update has_another_notif=false; pkill openEwwPopup.sh
