(custom-set-variables
 ...
 '(package-selected-packages
   '(openwith pinentry org-roam-ui ag dired all-the-icons-dired dired-narrow org-modern org-roam undo-tree centaur-tabs ivy-posframe dired-subtree ewal-doom-themes ewal emms bongo define-word expand-region company-box counsel ivy-hydra centered-window company-lsp lsp-ui ivy-rich doom-themes avy-zap transmission arduino arduino-mode org-drill go-eldoc lsp-mode mu4e-alert htmlize ox-reveal buffer-move go-mode desktop-environment exwm pass magit perspective flycheck yasnippet which-key web-mode vimish-fold use-package smartparens projectile pdf-tools org-bullets neotree multiple-cursors markdown-mode general evil eglot doom-modeline company avy auctex atom-one-dark-theme))
